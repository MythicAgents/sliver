...
class Portfwd(CommandBase):
    cmd = "portfwd"
    needs_admin = False
    help_cmd = "portfwd"
    description = "In-band TCP port forwarding"
    version = 1
    ...
    async def create_go_tasking(self, taskData: MythicCommandBase.PTTaskMessageAllData) -> MythicCommandBase.PTTaskCreateTaskingMessageResponse:
        ...
        # Sub Commands:
        # =============
        # TODO:  add  Create a new port forwarding tunnel
        # TODO:  rm   Remove a port forwarding tunnel

        response = await portfwd(taskData)
...
async def portfwd(taskData: PTTaskMessageAllData):
